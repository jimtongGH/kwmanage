...
public class Jiaoshi implements Serializable {
    ...
    public Jiaoshi(String jiaoshi_xingming, String jiaoshi_shoujihaoma, Integer xuexiao_id) {
        this.jiaoshi_xingming = jiaoshi_xingming;
        this.jiaoshi_shoujihaoma = jiaoshi_shoujihaoma;
        this.xuexiao_id = xuexiao_id;
    }

    public Jiaoshi(int jiaoshi_id, String jiaoshi_xingming, String jiaoshi_shoujihaoma) {
